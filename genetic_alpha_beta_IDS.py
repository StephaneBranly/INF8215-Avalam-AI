...
class MyAgent(Agent):
    ...
    def play(self, percepts, player, step, time_left):
        ...
        if player == 1 and step > 17 and step < 25:
            time_to_play *= 2
        print(time_left, time_to_play)
        board = dict_to_improved_board(percepts,True)

        actions = [(4, 2, 4, 3),[3, 1, 4, 0],[4, 0, 4, 1],[6, 2, 5, 1],[5, 1, 5, 0],[5, 2, 4, 1],[4, 3, 5, 4],[6, 4, 5, 3],[5, 3, 5, 4],[8, 6, 7, 7],[7, 7, 7, 6],[3, 2, 3, 3],[3, 3, 3, 4],[3, 4, 2, 4],[3, 5, 2, 4],[4, 6, 5, 5],[5, 5, 5, 6],[3, 8, 4, 8],[5, 7, 4, 8],[7, 5, 6, 6],[6, 6, 6, 7],[8, 5, 7, 6],[0, 2, 0, 3],[2, 3, 1, 3],[2, 6, 2, 5],[1, 4, 2, 5],[2, 2, 1, 3]]
        if step <28:
        ...
        while time.time()-start<time_to_play and depth<max_depth and not self.need_trimming(step,depth,start,time_to_play,last_time):
            ...
            print("depth: ", depth, "value: ", v, "time: ", time.time()-new_start)
